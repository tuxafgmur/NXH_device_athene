...
# Kernel
BOARD_KERNEL_CMDLINE := console=ttyHSL0,115200,n8 androidboot.console=ttyHSL0 androidboot.hardware=qcom msm_rtb.filter=0x237 ehci-hcd.park=3 androidboot.bootdevice=7824900.sdhci lpm_levels.sleep_disabled=1 earlyprintk cpu_max_c1=1651200
...
BOARD_HARDWARE_CLASS += $(LOCAL_PATH)/cmhw hardware/cyanogen/cmhw
